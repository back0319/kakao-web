...
// 가장 인기 있는 맛
let mostPopular = Object.entries(flavorDistribution).reduce(
  (max, curr) => (curr[1] > max[1] ? curr : max),
  ["", 0]
);
console.log(
  `Most popular flavor is ${mostPopular[0]} with ${mostPopular[1]} scoops sold`
); // Most popular flavor is Vanilla with 3 scoops sold
